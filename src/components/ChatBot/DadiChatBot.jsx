...
function DadiChatBot({ showOnHomepage = false }) {
  ...
  const [messages, setMessages] = useState([
    {
      type: 'bot',
      content: 'नमस्ते बेटा! मैं दादी चैटबॉट हूं। मैं आपकी स्वास्थ्य संबंधी समस्याओं में मदद कर सकती हूं। आप मुझसे किसी भी मेडिकल सवाल के बारे में पूछ सकते हैं। जैसे - बुखार, सर्दी-खांसी, पेट दर्द, या कोई और स्वास्थ्य समस्या।',
      timestamp: new Date()
    }
  ]);
  ...
  const isMedicalQuery = (text) => {
    const medicalKeywords = [
      'health', 'doctor', 'medicine', 'pain', 'fever', 'cold', 'cough', 'headache',
      'stomach', 'heart', 'blood', 'pressure', 'diabetes', 'treatment', 'symptom',
      'disease', 'illness', 'hospital', 'clinic', 'prescription', 'tablet', 'injection',
      'स्वास्थ्य', 'डॉक्टर', 'दवा', 'दर्द', 'बुखार', 'सर्दी', 'खांसी', 'सिरदर्द',
      'पेट', 'दिल', 'खून', 'दबाव', 'मधुमेह', 'इलाज', 'लक्षण', 'बीमारी', 'अस्पताल',
      'क्लिनिक', 'नुस्खा', 'गोली', 'इंजेक्शन', 'चिकित्सा', 'उपचार'
    ];
    
    const lowerText = text.toLowerCase();
    return medicalKeywords.some(keyword => lowerText.includes(keyword.toLowerCase()));
  };

  const callGeminiAPI = async (userMessage) => {
    try {
      const medicalPrompt = `You are "Dadi" (Grandmother), a caring and knowledgeable medical assistant chatbot. You should respond in a warm, grandmother-like manner in Hindi and English mix. 
...
Please respond as Dadi would, with care and medical knowledge.`;
      ...
      return data.candidates[0]?.content?.parts[0]?.text || 'मुझे समझने में कुछ परेशानी हो रही है। कृपया दोबारा पूछें।';
    } catch (error) {
  ...
  const handleSendMessage = async () => {
    ...
    if (!isMedicalQuery(userMessage)) {
      const nonMedicalResponse = {
        type: 'bot',
        content: 'बेटा, मैं केवल स्वास्थ्य और मेडिकल सवालों का जवाब दे सकती हूं। कृपया अपनी सेहत से जुड़े सवाल पूछें। जैसे - बुखार, सर्दी-खांसी, दर्द, या कोई और स्वास्थ्य समस्या के बारे में।',
        timestamp: new Date()
      };
    ...
    try {
      ...
      const errorMessage = {
        type: 'bot',
        content: 'बेटा, मुझे कुछ परेशानी हो रही है। कृपया बाद में पूछें या डॉक्टर से मिलें।',
        timestamp: new Date()
      };
                ...
                {message.type === 'bot' && (
                  <div className="message-actions">
                    <button
                      ...
                      title="सुनें"
                    >
                      <ion-icon name={isSpeaking ? "stop-outline" : "volume-high-outline"}></ion-icon>
          ...
          <div className="chatbot-input">
            <div className="input-group">
              <textarea
                ...
                placeholder={user ? `${user.name}, अपना स्वास्थ्य संबंधी सवाल यहां लिखें...` : "अपना स्वास्थ्य संबंधी सवाल यहां लिखें..."}
                rows="1"
                disabled={isLoading}
              />
              <button
